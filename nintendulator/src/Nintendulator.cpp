 ...
 *
 * $URL: file:///svn/p/nintendulator/code/nintendulator/trunk/src/Nintendulator.cpp $
 * $Id: Nintendulator.cpp 1353 2017-09-23 00:27:51Z quietust $
 */
...
LRESULT CALLBACK	WndProc (HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case ID_FILE_OPEN:
			...
			ofn.hInstance = hInst;
			// rveach: zip support
			ofn.lpstrFilter =	_T("All supported files (*.NES, *.UNIF, *.UNF, *.FDS, *.NSF, *.ZIP)\0")
							_T("*.NES;*.UNIF;*.UNF;*.FDS;*.NSF;*.ZIP\0")
