 ...
 *
 * $URL: file:///svn/p/nintendulator/code/mappers/trunk/src/iNES/mapper021.cpp $
 * $Id: mapper021.cpp 1355 2017-09-23 17:47:18Z quietust $
 */
...
{
	Addr = ((Addr & 0x006) >> 1) | ((Addr & 0x0C0) >> 6);
	PRG[0] = Val & 0x1F;
	Sync();
}
